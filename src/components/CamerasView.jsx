    ...
    <main className="dashboard view active-view" id="cameras-view">
      <div className="top-section">
        <div className="title-container">
          <h1 className="main-title">View Cameras<br/>in real time</h1>
        </div>
      </div>
      ...
      <div className="cameras-layout">
        ...
        <div className={`manual-controls ${mode === 'auto' ? 'hidden' : ''}`} id="manual-controls">
          <div className="directional-arrows">
            <button className="dir-btn up" id="dir-up">
            ...
            <div className="mid-row">
              <button className="dir-btn left" id="dir-left">
              ...
              <button className="dir-btn down" id="dir-down">
              ...
              <button className="dir-btn right" id="dir-right">
      ...
      <div className="bottom-bar">
        <div className="bar-section mode-section">
          ...
          <div className="mode-toggle">
            <button id="mode-auto" className={mode === 'auto' ? 'active' : ''} onClick={() => setMode('auto')}>Autonom</button>
