...
<div className="camera-feed active-feed" onClick={handleFullscreen} style={{ overflow: 'hidden', padding: 0, position: 'relative' }}>
            <img 
              src="http://127.0.0.1:8080/video_feed" 
              alt="Live AI Feed" 
              style={{ width: '100%', height: '100%', objectFit: 'cover' }}
            />
            <span className="camera-label" style={{ position: 'absolute', top: '16px', left: '16px', zIndex: 10 }}>Camera 1</span>
          </div>
