...
export default function HomeView({ isAlertVisible, closeAlert }) {
    ...
    <main className="dashboard view active-view" id="home-view">
      <div className="top-section">
        <div className="title-container">
          ...
          <h1 className="main-title">5G SOS Rover</h1>
        </div>
        
        <div className="alert-container">
          <div className={`alert-content ${isAlertVisible ? '' : 'hidden'}`}>
            <span className="pulse-ring"></span>
            <span className="alert-text">SOS Signal</span>
            <button className="close-alert" onClick={closeAlert} aria-label="Close Alert">&times;</button>
          </div>
        </div>
      </div>
