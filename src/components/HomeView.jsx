...
export default function HomeView({ activeCriticalAlert, closeAlert, onAlertClick, liveEvents, onUpdateEventStatus, canRespondToAlerts = false }) {
  ...
  return (
    <main className="dashboard view active-view" id="home-view">
        ...
        <div className="alert-container" aria-live="assertive">
          {activeCriticalAlert && (
            <button
              ...
              title={activeCriticalAlert.title}
            >
      ...
      <LiveEventFeed events={liveEvents} onStatusChange={onUpdateEventStatus} canRespondToAlerts={canRespondToAlerts} />
