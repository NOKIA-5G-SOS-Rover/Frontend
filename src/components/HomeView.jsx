...
export default function HomeView({ activeCriticalAlert, closeAlert, onAlertClick, onOpenPastAlert, onExploreRover, liveEvents, onUpdateEventStatus, archiveReferenceDate = new Date() }) {
        ...
        <div className="hero-section__grid">
          <div className="hero-copy hero-copy--simplified">
            ...
            <dl className="hero-metrics" aria-label="Current rover status">
              <div><dt>Link</dt><dd><span className="metric-dot" aria-hidden="true" />5G / stable</dd></div>
