...
export default function PastAlertsView({ liveEvents = [], focusedAlertId = null, connection }) {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (selectedAlert && e.key.toLowerCase() === 'r') resetZoom();
      if (selectedAlert && e.key.toLowerCase() === 'f') toggleFullscreen();
    };
  ...
  const allAlerts = useMemo(() => [...liveCriticalAlerts, ...pastAlerts], [liveCriticalAlerts, pastAlerts]);
  ...
  const criticalTotal = pastAlerts.filter((alert) => alert.severity === 'critical').length;
